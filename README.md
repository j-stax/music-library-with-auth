...
A song database web application built on the MERN stack (MongoDB, Express, React, Node.js). It allows users to manage their own personal library of song titles and other song details. Users can also perform searches by artist and genre for quick filtering. The application also features JWT token-based user authentication and password hashing with bcryptjs.
